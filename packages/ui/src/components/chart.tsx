...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style
      // eslint-disable-next-line react/no-danger -- CSS variables built from THEMES + ChartConfig (developer-controlled, not user input). Renders <style> for chart theming.
