...
Modern static content blog. pnpm + turbo monorepo. Vite + React 19 frontend, Prismic for content. Docker + Nginx for deploy on GCP infrastructure.
...
pnpm --filter @workspace/web dev         # dev just the web app
